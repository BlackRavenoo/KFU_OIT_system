...
│   │       ├── assets/                # Функции управления активами
...
│   │       │   └──  messages/         # Функции для работы с чатом
